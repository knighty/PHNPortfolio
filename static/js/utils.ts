 ...
 * @param options
 */
export function observeScopedEvent<T extends keyof Events>(scopedElement: Node, event: T, selector: string, options?: Partial<ScopedEventOptions<Events[T]>>): Observable<readonly [Events[T], HTMLElement]> {
