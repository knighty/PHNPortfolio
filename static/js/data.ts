...
export default {
	...
	categories: [
		...
		},
		{
			...
			size: "1000x150",
			description: `<p>Some logos need to be clean and simple, while some need to stand out against a sea of banality. Whichever extreme or anything in between, you can be certain that your logo will have the thought and care put into it that it deserves.</p>`,
			items: [
				{
					name: "Brokers",
